...
The package acts as a convinient wrapper around public data sources. All data is provided in a tidy format in a `tibble` object. Datasets are updated weekly or monthly, depending on the source.
