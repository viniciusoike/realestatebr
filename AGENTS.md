...
This file contains configuration and commands for Codex to help with
package development.
...
- Use RStudio-style section headers for code organization:
  `# Section ----`, `## Subsection ----`, `### Subsubsection ----` with
  trailing dashes to fill to ~76 characters. Never use box-style
  comments with `====` borders above and below. Keep comments concise.
