...
``` r
list_datasets()
#> Found 11 datasets. Use `get_dataset()` for "materialized" entries and
...
#>  3 bcb_reales… BCB … materializ… accounting, app… Detailed r… Brazil (… 2001-pr…
...
#>  7 pim_pf_con… PIM-… materializ… (single table)   Linked mon… Brazil    January…
#>  8 rppi        Braz… materializ… fipezap, ivgr, … Brazilian … Brazil    varies …
#>  9 rppi_bis    BIS … materializ… selected, detai… Internatio… Internat… 1970-pr…
#> 10 secovi      SECO… materializ… condo, rent, la… São Paulo … São Paulo 2004-pr…
#> 11 sinapi      SINA… materializ… (single table)   Monthly co… Brazil, … March 1…
